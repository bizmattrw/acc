...
font-size: 20px; font-weight: bold; line-height: 28px; text-shadow: 2px 2px 0 #FFFFFF;">Recording Retains</div>

<FORM action="saveretained.php" method="post">
...
<div class="form-group">
                        <label>Source</label>
                        <input  name="reason" type="text" class="form-control input-sm" id="reason" style="width: 180px; text-align: center" placeholder="Income Resources" required />
