...
<FORM action="expenses1.php" method="GET">
...
<select onchange="location = this.options[this.selectedIndex].value;">
    <option>Please select Proof</option>
    <option value="<?php echo"expenses1.php?year=$year";?>">None</option>
    <option value="<?php echo"expensesreceipt.php?year=$year";?>">Receipt</option>
    <option value="http://<?php echo"expensesmissioorder.php?year=$year";?>">Mission Order</option>
</select>						
</div></td>
