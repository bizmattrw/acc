...
<div class="panel"><div class="header">
  ...
  </div><div class="title">IYONGERAMUTUNGO</div></div><div class="body">
  ...
  <td style="text-align: right; font-weight: bold; width: 1px; white-space: nowrap">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-list" id="example">
								...
								$date2=$_POST['date2'];
								  ...
								  $totvalue=0;
								  $user_query=mysqli_query($con,"select * from iyongeramutungo where coopid='$_SESSION[coopid]' and date between '$date1' and '$date2' ")or die(mysqli_error($con));
									...
									<td align="center"><?php echo number_format($row['amount']);
									$totvalue += $row['amount'];?></td>
