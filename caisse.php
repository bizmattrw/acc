...
<div class="form-group">
                        <label>Reason</label>
                        <input  name="reason" type="text" class="form-control input-sm" id="reason" style="width: 180px" required />
...
<tr><td style="padding: 0px; padding-left: 5px"><div class="form-group">
                        <label>Action</label>
                     <input name="action" type="radio" value="credit" required>Credit &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
					 <input name="action" type="radio" value="debit" required>Debit
</div></td>
