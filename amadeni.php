...
<FORM action="saveamadeni.php" method="post" enctype="multipart/form-data">
...
<div class="form-group">
                        ...
                        <input  name="reason" type="text" class="form-control input-sm" id="reason" style="width: 180px" required /></td>
                       <div class="form-group"><td style="padding: 20px"> <label>Piece No</label>
<?php 
include'dbcon.php';
$sel1=mysqli_query($con,"select id from amadeni where coopid='$_SESSION[coopid]' order by id desc limit 1") or die(mysqli_error($con));
...
<input name="owner" type="text" class="form-control input-sm" id="value" style="width: 180px; text-align: center" placeholder="Owner" required  />					
</div></td>
<td style="padding: 0px; padding-left: 5px"><div class="form-group"><label>Date</label><div class="controls">
                        <input name="date1" type="date" class="form-control input-sm" id="date" style="width: 100px; margin-bottom: 10px; text-align: center"  title=" date "/>
                      </div></td>
<td style="padding: 0px; padding-left: 5px"><div class="form-group"><label>Date to pay</label><div class="controls">
                        <input name="date2" type="date" class="form-control input-sm" id="date" style="width: 100px; margin-bottom: 10px; text-align: center"  title=" date "/>
                      </div></td>
