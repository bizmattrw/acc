...
font-size: 20px; font-weight: bold; line-height: 28px; text-shadow: 1px 1px 0 #FFFFFF;">CREDITS PAYMENT</div>
<?php include("header.php");?>		
                                  <?php 
								include('dbcon.php');
								  $id=$_GET['id'];
$sel=mysqli_query($con,"select * from amadeni where id='$id'");
...
?>
<FORM action="savelpaymentamadeni.php" method="post">
...
<div class="form-group">
                        <label>Impamvu</label>
                        <input  name="ideni" type="text" class="form-control input-sm" id="reason" style="width: 200px" required value="<?php echo $ideni?>" />
