...
font-size: 18px; font-weight: bold; line-height: 20px; text-shadow: 2px 2px 0 #FFFFFF;">BUDGET LINES
                   <a href="budgetline.php"> <button type="button" class="btn btn-sm btn-primary btn-create">New Entry</button></a>
				   <a href="approvisionement.php"> <button type="button" class="btn btn-sm btn-primary btn-create">Budget Revision</button></a></DIV>
...
<?php include('header.php'); ?>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-list" id="example">
								...
								include('dbcon.php');
								  $year=date("Y");
								  $user_query=mysqli_query($con,"select * from account where year='$year' and coopid='$_SESSION[coopid]' and status=0")or die(mysqli_error($con));
									while($row=mysqli_fetch_array($user_query)){
									$id=$row['id']; ?>
									 <tr class="del<?php echo $id ?>">
                                    <td align="center"><?php echo $row['codename']; ?></td> 
                                    <td align="center"><?php echo $row['budgetcode']; ?></td> 
                                    ...
                                    <td width="100">
                                    	...
                                    	<?php include('modal_edit_budget.php'); ?>
									</td>
									 ...
									 <i class="icon-trash icon-large"></i></a>
                                        <?php include('deletebudget.php'); ?></td>
