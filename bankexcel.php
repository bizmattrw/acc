              ...
              <div class="panel-heading">
                <div class="row">
				  ...
				  <?PHP $account=$_GET['account'];$bank=$_GET['bank'];$date1=$_GET['date1'];$date2=$_GET['date2'];?>
                    <h3 class="panel-title"><font color="#FFFFFF"></font>THE DETAILS ON ACCOUNT: 
					<?php echo"$account";?></h3>
                  </div></div>
...
if(mysqli_num_rows($sel)<=0){echo"<center>Sorry no record found</center>";}
	...
	<tr>
   <th align=center colspan=9>Opening balance=$balancef</th></tr>
   <tr>
    <th align=center>Date</td><th align=center>OrderNo</td><th align=center>Reference No</td> <th align=center>Account</td> <th align=center>Bank name</td>
