...
font-size: 20px; font-weight: bold; line-height: 28px; text-shadow: 1px 1px 0 #FFFFFF;">Updating Liabilities</div>
...
?>
<FORM action="editstock1.php" method="post">
...
<div class="form-group">
                        <label>Item</label>
                        <input  name="item" type="text" class="form-control input-sm" id="reason" style="width: 180px" required value="<?php echo $item?>" />
...
<td style="padding: 0px; padding-left: 5px"><div class="form-group">
                  ...
                  <input name="qa" type="text" class="form-control input-sm" id="value" style="width: 100px; text-align: center"  required
						 value="<?php echo $qa?>"   />
</div></td>
<td style="padding: 0px; padding-left: 5px"><div class="form-group">
                        <label>Quantity Removed</label>
                        <input name="qr" type="text" class="form-control input-sm" id="value" style="width: 100px; text-align: center"  required
						 value="<?php echo $qr?>"   />
</div></td>
</tr>
<tr>
...
<td style="padding: 0px; padding-left: 5px"><div class="form-group"><label>Action</label><div class="controls">
                        <input name="action" type="text" class="form-control input-sm" id="date"  style="width: 100px; margin-bottom: 0px; text-align: center"
