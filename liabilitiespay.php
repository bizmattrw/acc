...
$remain=$_GET['remain'];
?>
<table style="padding: 30px"><thead><tr><th style="font-weight: bold; font-size: 16px; text-align: center; padding-bottom: 10px" colspan="2"><?php echo"Uburyo $ideni ";?></th></tr>
<tr><th style="font-weight: bold; font-size: 24px; text-align: center; padding-bottom: 10px" colspan="2"><?php echo"yishyuwemwo Ideni rye";?></th></tr>
<tr><th style="font-weight: bold; font-size: 16px; text-align: center; padding-bottom: 10px" colspan="2"><?php echo" KUGEZA:$date2";?></th></tr>
...
$sel=mysql_query("select amount as amount,liability,date from levelscaisse where date<='$date2' and liability='$ideni'  order by date asc ") or die(mysql_error());
$totcredit=$totampay=0;
   echo"<thead> <tr>
   <th style='padding: 3px; padding-left: 25px; padding-left: 5px; border-top-width: 1px; border-bottom-width: 1px; font-weight: bold'>ITARIKI</td> 
   <th style='padding: 3px; padding-left: 25px; padding-left: 5px; border-top-width: 1px; border-bottom-width: 1px; font-weight: bold'> AYO YISHYUWE</td>
   </TR></thead><tbody>";
...
<tr><td title="UKO YISHYUWE" style="padding: 3px; padding-right: 25px; padding-left: 5px; border-top-width: 1px; border-bottom-width: 1px; font-weight: bold">IDENI RYOSE RYISHYUWE</td>
...
<tr><td style="padding: 3px; padding-right: 25px; padding-left: 5px; border-top-width: 1px; border-bottom-width: 1px; font-weight: bold">IDENI RYOSE RISIGAYE</td>
<td style="padding: 3px; border-top-width: 1px; border-bottom-width: 1px; white-space: nowrap; text-align: right; font-weight: bold">
<?php $remainf=number_format($remain); echo"$remainf";?></td>
</tr>
