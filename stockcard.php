              ...
              <div class="panel-heading">
                <div class="row">
				  ...
				  <?PHP $date1=$_GET['date1'];$date2=$_GET['date2'];?>
                    <h3 class="panel-title"><font color="#FFFFFF"><<</font><a href="stockform.php">
					<img src="images/home.png" title="Home"/></A>SUMMARY OF STOCK: 
					<?php echo"FROM $date1 UNTIL $date2";
					echo"<a href='stockcardexcel.php?date1=$date1&&date2=$date2'><img src='images/xls.png'>";
					?></a>
					</h3>
                  </div></div>
