...
font-size: 18px; font-weight: bold; line-height: 20px; text-shadow: 2px 2px 0 #FFFFFF;">LIABILITY ITEMS
                   <a href="liabilityitem.php"> <button type="button" class="btn btn-sm btn-primary btn-create">New Liability</button></a></DIV>
...
<?php include('header.php'); ?>
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-list" id="example">
								...
								include('dbcon.php');
								  ...
								  $user_query=mysqli_query($con,"select * from instititution where coopid='$_SESSION[coopid]' order by id asc")or die(mysqli_error($con));
									while($row=mysqli_fetch_array($user_query)){
									$id=$row['id']; ?>
									 <tr class="del<?php echo $id ?>">
                                    <td align="center"><?php echo $row['liability']; ?></td> 
                                    ...
                                    <td width="100">
                                    	...
                                    	<?php include('modal_edit_liabilityitem.php'); ?>
									</td>
									 <td><a rel="tooltip"  title="delete" id="<?php echo $id; ?>"  href="#delete_user<?php echo $id; ?>" data-toggle="modal"  class="btn btn-danger"><i class="icon-trash icon-large"></i></a>
                                        <?php include('deleteliabityitem.php'); ?></td>
