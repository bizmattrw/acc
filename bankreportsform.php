...
{
var val=form.cat.options[form.cat.options.selectedIndex].value;
self.location='bankreportsform.php?cat=' + val ;
}
...
<td>&nbsp;</td>			
        <td>&nbsp;</td></tr></table>
<hr/><br />
 <form action="banktrialbalance.php" method="post" name="form1">
...
$quer2=mysqli_query($con,"SELECT DISTINCT Level,Level_id FROM level where coopid='$_SESSION[coopid]' order by Level_id"); 
///////////// End of query for first list box////////////

/////// for second drop down list we will check if category is selected else we will display all the subcategory/////
if(isset($cat) and strlen($cat) > 0){
$quer=mysqli_query($con,"SELECT DISTINCT Combination FROM combination where Level_id=$cat and coopid='$_SESSION[coopid]' order by Combination"); 
}else{$quer=mysqli_query($con,"SELECT DISTINCT Combination FROM combination  where coopid='$_SESSION[coopid]' order by Combination"); } 
...
echo "</select>";?> </td>
  <tr> 
    <td><label id="nam">From:</label></td>
    <td align="left"><input onClick="ds_sh(this);" name='date1'  style="cursor: text" size="8"></td>
  </tr>
  <tr> 
    <td><label id="am">Until:</label></td>
    <td align="left"><input onClick="ds_sh(this);" name='date2'  style="cursor: text" size="8"></td><td>
  </tr>
