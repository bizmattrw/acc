	<div id="delete_user<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-body">
			<div class="alert alert-danger">Are you sure you want to remove this user?</div>

		</div>
		<div class="modal-footer">
			<a class="btn btn-danger" href="deleteusers.php<?php echo '?id='.$id; ?>"><i class="icon-check"></i>&nbsp;Yes</a>
