			...
			if (this.value=='transfer')
			 ...
			 ">
								...
								<tr>
									...
									<td style="padding: 0px; padding-left: 5px">
										<div class="form-group">
											<input name="particular" type="text" id="particular" onKeyPress="return numbersonly(event,false)" required />
										</div>
									</td>
								</tr>
								<tr>
								...
								<tr>
									<td><label style="display: inline;">Budget line: </label></td>
									<td style="padding: 0px; padding-left: 5px">
										<div class="form-group">
								...
								<tr>
									<td style="padding: 0px; padding-left: 5px">
										<div class="form-group">
											<input name="slip" type="text" style="visibility:hidden;" />
										</div>
									</td>
								</tr>
								<tr>
									...
									<tr>
										...
										<td style="padding: 0px; padding-left: 5px">
											<div class="form-group">
												...
												<select style="display: inline;" name="budget-line[]" type="text" class="form-control input-sm budget-line" style="width: 180px; text-align: center" placeholder="Income Resources" required onchange="loadBugdetLineAmount(this)">
													<option></option>
													<?php
										...
										<td style="padding: 0px; padding-left: 5px">
											<div class="form-group">
												...
												<input style="display: inline;" name="budget-line-amount[]" type="text" class="form-control input-sm budget-line-amount" style="width: 100px; text-align: center" placeholder="Current Amount" required readonly />
											</div>
										</td>
										<td style="padding: 0px; padding-left: 5px">
											<div class="form-group">
												<label>Particular: </label>
												<input style="display: inline;" name="budget-particular[]" type="text" class="form-control input-sm" id="value" style="width: 100px; text-align: center" placeholder="Particular" required />
											</div>
										</td>
										<td style="padding: 0px; padding-left: 5px">
											<div class="form-group">
												<label>Reason: </label>
												<input style="display: inline;" name="budget-reason[]" type="text" class="form-control input-sm" id="value" style="width: 100px; text-align: center" placeholder="Reason" required />
											</div>
										</td>
										<td style="padding: 0px; padding-left: 5px">
											<div class="form-group">
												<label>Amount Spent: </label>
												<input style="display: inline;" name="amount-spent[]" type="text" class="form-control input-sm amount-spent" style="width: 100px; text-align: center" placeholder="Amount Spent" required oninput="validateInput(this)" />
											</div>
										</td>
									</tr>
								</tbody>
								...
								<tbody id="transfer-based" style="display: none;">
									<tr>
										...
										<td style="padding: 0px; padding-left: 5px">
											<div class="form-group">
												<label>Amount: </label>
												<input oninput="validateInput1(this, 'transfer');" style="display: inline;" name="transfer-amount[]" type="text" class="form-control input-sm transfer-amount" style="width: 100px; text-align: center" placeholder="Source" required />
											</div>
										</td>
									</tr>
								</tbody>
