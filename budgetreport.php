...
$year=$_POST['year'];
$footer=$_POST['footer'];
echo"EXPORT TO EXCEL <a href='budgetreportexcel.php?year=$year&&title=$title&&description=$description&&footer=$footer'><img src='images/xls.png'>";?>
</a>&nbsp;</tr></table></div>
...
<td style="padding: 3px; padding-left: 25px; padding-left: 5px; border-top-width: 1px; border-bottom-width: 1px; font-weight: bold"><?php $account=$row['codename'];
 echo "<a href='budgetlineform.php?account=$account'>$account</a>"; ?></td> 
