...
<div class="panel"><div class="header">
  ...
  </div><div class="title">REVISIONS</div></div><div class="body">
 <?php echo"EXPORT TO EXCEL <a href='revisedreportexcel.php?date1=$date1&&date2=$date2'><img src='images/xls.png'>";?>
</a>
  <table><tr>
  <td style="text-align: right; font-weight: bold; width: 1px; white-space: nowrap">
                            ...
                            <table cellpadding="0" cellspacing="0" border="0" class="table table-striped table-bordered table-list" id="example">
                                ...
                                <?php
                                                                ...
                                                                echo "<tr><b><td colspan='2' align='center'>TOTAL</Td><td align='center'>$totbline1f</td><td align=center>$totrevisedf</td><th></th><td align=center>$totbline2f</td><td align=center>$totaccreditedf</td></tr>";
                                                                ?>
                            </table>
</td>
 </td></tr></table></div></div>
