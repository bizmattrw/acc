	<div id="edit<?php echo $id; ?>" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
		<div class="modal-body">
			<div class="alert alert-info"><strong>Editing Source of Incomes wrong entries</strong></div>

	<form class="form-horizontal" method="post" enctype="multipart/form-data" action="updatesources3.php">
        ...
        <div class="controls"> 
          <input type="text"  class="span2" id="fname" name="account"   value="<?php echo $row['codename']; ?>">
        </div>
		</div>
