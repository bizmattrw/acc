...
<tr><th style="font-weight: bold; font-size: 24px; text-align: center; padding-bottom: 10px" colspan="2"><?php echo"yishyuyemwo Ideni rye";?></th></tr>
...
$sel=mysql_query("select value as amount,ideni,date from login where date<='$date2' and ideni='$ideni'  order by date asc ") or die(mysql_error());
$totcredit=$totampay=0;
   ...
   <th style='padding: 3px; padding-left: 25px; padding-left: 5px; border-top-width: 1px; border-bottom-width: 1px; font-weight: bold'> AYO YISHYUYE</td>
   </TR></thead><tbody>";
