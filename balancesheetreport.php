...
<?php echo"$date1 UNTIL $date2"; echo"<a href='balancesheetreportexcel.php?date1=$date1&&date2=$date2'><img src='images/xls.png'></a>";?></div>
...
<div style="text-align: center; color: #ccc; font-size: 12px; text-shadow: 1px 1px 0px #fff">     
  ...
  <div class="body"><table><tr><td style="text-align: right; font-weight: bold; width: 1px; white-space: nowrap">
                             ...
                             <tr bgcolor="#FFFFFF"><th align="center">Item</th><th>Value</th></tr>
			                                  ...
			                                  <?php 
		$totliabilities=0;						  
$sel=mysqli_query($con,"select sum(amount) as term,source from liabilities where date>='$date1' and date<='$date2' and coopid='$_SESSION[coopid]'
 group by source order by source asc") or die(mysqli_error($con));
