...
<td style="width: auto"></td></tr></table></div></div><div class="print-reset" style="padding: 35px; padding-top: 85px">
...
font-size: 20px; font-weight: bold; line-height: 28px; text-shadow: 1px 1px 0 #FFFFFF;">Updating Retains</div>
                                  <?php 
								include('dbcon.php');
								  $id=$_GET['id'];
$sel=mysql_query("select * from income where id='$id'");
...
?>
<FORM action="update_retained1.php" method="post">
...
<div class="form-group">
                        <label>Source</label>
                        <input  name="reason" type="text" class="form-control input-sm" id="reason" style="width: 180px" required value="<?php echo $source?>" />
