...
<html lang="en">
    <head>
		...
		?>
		<link rel="stylesheet" href="datatables1/DataTables-1.10.18/css/dataTables.bootstrap4.min.css">
		<link rel="stylesheet" href="datatables1/Buttons-1.5.4/css/buttons.bootstrap4.min.css">
		<link rel="stylesheet" href="datatables1/FixedHeader-3.1.4/css/fixedHeader.bootstrap4.min.css">
		<script type="text/javascript" src="datatables1/DataTables-1.10.18/js/jquery.dataTables.min.js"></script>
		<script type="text/javascript" src="datatables1/DataTables-1.10.18/js/dataTables.bootstrap4.min.js"></script>
		<script type="text/javascript" src="datatables1/FixedHeader-3.1.4/js/dataTables.fixedHeader.min.js"></script>
		<script type="text/javascript" src="datatables1/FixedHeader-3.1.4/js/fixedHeader.bootstrap4.min.js"></script>
		<script type="text/javascript" src="datatables1/Buttons-1.5.4/js/dataTables.buttons.min.js"></script>
		<script type="text/javascript" src="datatables1/Buttons-1.5.4/js/buttons.bootstrap4.min.js"></script>
		<script type="text/javascript" src="datatables1/Buttons-1.5.4/js/buttons.flash.min.js"></script>
		<script type="text/javascript" src="datatables1/JSZip-2.5.0/jszip.min.js"></script>
		<script type="text/javascript" src="datatables1/pdfmake-0.1.36/pdfmake.min.js"></script>
		<script type="text/javascript" src="datatables1/pdfmake-0.1.36/vfs_fonts.js"></script>
		<script type="text/javascript" src="datatables1/Buttons-1.5.4/js/buttons.html5.min.js"></script>
		<script type="text/javascript" src="datatables1/Buttons-1.5.4/js/buttons.print.min.js"></script>
		
		<script>
            $(document).ready(function(){
				$('#example').dataTable({
					"sPaginationType" : "full_numbers",
					"dom": '<"top"Bf<"clear">l>rt<"bottom"ip<"clear">>',
					buttons: [
						"excel", "pdf", "print"
					],
                                                ...
                                                if ($result->num_rows > 0) {
                                                    ...
                                                    while ($row = $result->fetch_assoc()) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?php echo fetchNow("VillageName", "villages", "VillageId = '$villageId'"); ?></td>
                                                        </tr>
                                                        <?php
                                                    }
                                                }
