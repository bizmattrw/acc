...
<img src="images/coprorizbanner.png" height="50"></th></tr>
...
de la part du COOPRORIZ MUKUNGURI</td></tr>
<tr><td  style='padding: 5px';>  <font size='+1'>pour...<strong>$reason</strong>...
</td></tr>
<tr><td  style='padding: 5px';> <font size='+1'> ce montant est pay&eacute; par cheque No
...<strong>$chequeno</strong>...
</td>

</tr>");
mysql_query("insert into receipt values('','$names','$reason','$amount','$chequeno','$date')") OR die(mysql_error());
