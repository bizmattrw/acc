...
<div class="panel panel-default">
    <div class="panel-heading"><span class="header">Income Sources Report Form</span></div>
<div class="panel-body" style="background-color: #f9f9f9; box-shadow: inset 0px 1px 0px #fff; padding: 30px">
<FORM action="incomesourcesreport.php" method="post" target="_blank">
...
<td>
						...
						<option></option>
								...
								include('dbcon.php');
								  ...
								  $user_query=mysqli_query($con,"select * from sources where coopid='$_SESSION[coopid]' group by year")or die(mysqli_error($con));
