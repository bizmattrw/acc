...
font-size: 20px; font-weight: bold; line-height: 28px; text-shadow: 2px 2px 0 #FFFFFF;">Recording Liabilities</div>

<FORM action="saveliability.php" method="post">
...
<div class="form-group">
                        ...
                        <select  name="reason[]" type="text" class="form-control input-sm" id="reason" style="width: 180px; text-align: center" placeholder="Income Resources" required />
						<option></option>
                                  <?php 
								  $year=date("Y");
								...
								include('dbcon.php');
								  ...
								  $user_query=mysqli_query($con,"select * from instititution where coopid='$_SESSION[coopid]' order by liability asc")or die(mysqli_error($con));
									while($row=mysqli_fetch_array($user_query)){
									$account=$row['liability']; 
...
<div class="form-group"><label>Date</label><div class="controls">
                        <input name="date" type="DATE" class="form-control input-sm" id="date" style="width: 150px; margin-bottom: 0px; text-align: center"  title=" date " 
