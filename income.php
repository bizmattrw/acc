...
font-size: 20px; font-weight: bold; line-height: 28px; text-shadow: 2px 2px 0 #FFFFFF;">Recording Incomes</div>
...
<div class="form-group">
						...
						<option></option>
								...
								include('dbcon.php');
								  ...
								  $user_query=mysqli_query($con,"select * from sources where year='$year' and coopid='$_SESSION[coopid]' group by codename")or die(mysql_error());
