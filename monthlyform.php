...
<div class="panel panel-default"><div class="panel-heading"><span class="header">Monthly Operational Report Form</span></div>
<div class="panel-body" style="background-color: #f9f9f9; box-shadow: inset 0px 1px 0px #fff; padding: 30px">
<FORM action="operationalreport.php" method="post" target="_blank">
