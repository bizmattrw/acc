...
<?php include("header.php");?>		
								...
								include('dbcon.php');
								  $id=$_GET['id'];
$sel=mysqli_query($con,"select * from liabilities where id='$id'");
...
?>
<FORM action="update_liability1.php" method="post">
...
<div class="form-group">
						...
						<?php
						$sel=mysqli_query($con,"select * from instititution where coopid='$_SESSION[coopid]'")or die(mysqli_error($con));

                        while($med=mysqli_fetch_array($sel))
                          {
                           $source=$med['liability'];
