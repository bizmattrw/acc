...
<FORM action="saveexpensesreceipt.php" method="post">
...
<div class="form-group">
						...
						<select name="account" class="form-control input-sm" required>
						<option></option>
                                  <?php 
								  $year=$_GET['year'];
								include('dbcon.php');
...
<div class="form-group">
                        <label>Reason</label>
                        <input name="reason" type="text" class="form-control input-sm" id="value" style="width: 200px; text-align: center" placeholder="Reason" required  />
</div></td><td style="padding: 0px; padding-left: 5px">
<div class="form-group">
                        <label>Amount</label>
...
<div class="form-group">
                        ...
                        <input name="receiver" type="text" class="form-control input-sm" id="value" style="width: 200px; text-align: center" placeholder="Someone to receive" required  />
						</div></td>
<td style="padding: 0px; padding-left: 5px">
<label>Date</label><div class="controls">
