...
font-size: 20px; font-weight: bold; line-height: 28px; text-shadow: 1px 1px 0 #FFFFFF;">LIABILITIES PAYMENT</div>
<?php include("header.php");?>		
                                  <?php 
								include('dbcon.php');
								  $id=$_GET['id'];
$sel=mysql_query("select * from liabilities where id='$id'");
...
?>
<FORM action="savelpayment.php" method="post">
...
<div class="form-group">
                        ...
                        <input  name="liability" type="text" class="form-control input-sm" id="reason" style="width: 180px" required value="<?php echo $source?>" />
						<input  name="id" type="hidden"  required value="<?php echo $id?>" />

</div></td><td style="padding: 0px; padding-left: 5px"><div class="form-group">
                        <label>Amount</label>
                        <input name="amount" type="text" class="form-control input-sm" id="value" style="width: 100px; text-align: center" placeholder="Amount" required
...
<td style="padding: 0px; padding-left: 5px"><div class="form-group"><label>Date</label><div class="controls">
                        <input name="date" type="text" class="form-control input-sm" id="date"  style="width: 100px; margin-bottom: 0px; text-align: center"  title=" date " 
						 onclick="ds_sh(this);"  data-bind="datePicker: StartDate" required/>
                      </div></div></td>
<td style="padding: 0px; padding-left: 5px"><div class="form-group"><label>Amount Paid</label><div class="controls">
                        <input name="amountpay" type="text" class="form-control input-sm" id="date"  style="width: 100px; margin-bottom: 0px; text-align: center"  title="Paid Amount" />
                      </div></div></td>
</table><div></div></div>
