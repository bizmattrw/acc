...
font-size: 18px; font-weight: bold; line-height: 20px; text-shadow: 2px 2px 0 #FFFFFF;">Liabilities Editing
                   </div>
...
$sel=mysql_query("select * from levelscaisse");
   echo"<thead> <tr><td align=center><em class='fa fa-cog'>Settings</em></td>
   <th align=center>Date</td><th align=center>Liability</td> <th align=center>Amount</td>
   </TR></thead><tbody>";
...
<td style=\"width: 1px\"><a href=\"deletelevelscaisse.php?id=$id&&amount=$amount&&lid=$lid\"  class=\"btn btn-danger\">Delete</a></td><td align=center> $date</td>
