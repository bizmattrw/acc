...
<td style="vertical-align: middle"><span style="text-shadow: 1px 1px 0 #FFFFFF; color: #555555; font-size: 18px; font-weight: bold">COOPA SYSTEM</span>
                  ...
                  <td class="count-column hide-on-collapse" style="text-align: right; padding-right: 10px; width: 1px"><span class="count count-zero">0</span></td></tr>
								  ...
								  <div><table><tr>
                  <td><a href="updateincome.php" class="tab-link"><img src="resources/webalys/_16px/text-9.png" />
				  <span class="tab-label hide-on-collapse">Income</span><span class="show-on-collapse hidden"><span class="tooltiptext">Income</span></span></a></td>
								  ...
								  <div><table><tr>
                  <td><a href="updatecaisse.php" class="tab-link"><img src="resources/webalys/_16px/text-9.png" />
				  <span class="tab-label hide-on-collapse">Caisse</span><span class="show-on-collapse hidden"><span class="tooltiptext">Caisse</span></span></a></td>
								  ...
								  <div><table><tr>
                  <td><a href="updateexpenses.php" class="tab-link"><img src="resources/webalys/_16px/text-9.png" />
				  ...
				  <div><table><tr>
                  <td><a href="updateassets.php" class="tab-link"><img src="resources/webalys/_16px/text-9.png" />
				  ...
				  <div>
				  <table><tr>
                  <td><a href="updatestock.php" class="tab-link"><img src="resources/webalys/_16px/text-9.png" />
				  <span class="tab-label hide-on-collapse">Stock</span><span class="show-on-collapse hidden"><span class="tooltiptext">Stock</span></span></a></td>
								  ...
								  <div><table><tr>
                  <td><a href="updateamadeni.php" class="tab-link"><img src="resources/webalys/_16px/text-9.png" />
				...
				<div><table><tr>
                  <td><a href="updateretained.php" class="tab-link"><img src="resources/webalys/_16px/text-9.png" />
...
font-size: 20px; font-weight: bold; line-height: 28px; text-shadow: 2px 2px 0 #FFFFFF;">Updating Caisse</div>
                                  <?php 
								include('dbcon.php');
								  $id=$_GET['id'];
$sel=mysql_query("select * from caisse where id='$id'");
...
?>
<FORM action="update_caisse1.php" method="post">
...
<div class="form-group">
                        <label>Reason</label>
                        <input  name="reason" type="text" class="form-control input-sm" id="reason" style="width: 180px" required value="<?php echo $reason?>" />
...
<tr><td style="padding: 0px; padding-left: 5px"><div class="form-group">
                        <label>Action</label>
						<select name="action" class="form-control input-sm" id="value" style="width: 80px; text-align: center">
						<option  value="<?php echo $source?>"><?php echo $action?></option><option value="debit">Debit</option><option value="credit">Credit</option></option></select>
</div></td>
<td style="padding: 0px; padding-left: 5px"><div class="form-group"><label>Date</label><div class="controls">
                        <input name="date" type="text" class="form-control input-sm" id="date" style="width: 100px; margin-bottom: 0px; text-align: center"  title=" date " 
						 onclick="ds_sh(this);"
 data-bind="datePicker: StartDate" value="<?php echo $date?>" />
                      </div></div></td>
