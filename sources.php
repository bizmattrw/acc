...
<div class="form-group"><label>Source </label><input type="text" class="form-control input-sm" style="width: 250px"  name="account[]" />
</div></td><td style="padding: 0px; padding-left: 5px"><div class="form-group"><label>Amount</label>
<input type="text" class="form-control input-sm" style="width: 100px; text-align: center" name="amount[]" placeholder="Amount"  />
</div></td></tr></tbody></table><div class="form-group"><label>Year</label><div class="controls">
...
</FORM><a href="updatesources.php"><input type="button" id="btnCreate" class="btn" style="font-weight: bold" aria-hidden="true" value="Edit" />
